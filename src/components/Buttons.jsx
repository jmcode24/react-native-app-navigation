...
const Buttons = () => {
  ...
  return (
    <Tab.Navigator screenOptions={{ tabBarActiveTintColor: 'orange'}} >
      <Tab.Screen name="Home" component={Home} options={{ tabBarIcon: (props) => (<AntDesign name="home" size={25} color="black" style={{ color: props.color}} />), tabBarLabel: () => {return null}, headerTitle: (props) => <HomeHeader {...props}/>}}/>
